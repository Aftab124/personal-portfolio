...
import resumeIcon from '../assets/img/resume.svg'; // Import your resume icon
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            ...
            <span className="navbar-text">
              <div className="social-icon">
                ...
                <a href="https://beige-dinny-45.tiiny.site/" download><img src={resumeIcon} alt="Resume" /></a> {/* Add download attribute to trigger download */}
              </div>
              <HashLink to='#connect'>
